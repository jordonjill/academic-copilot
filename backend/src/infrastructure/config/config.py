...
# ===== STM/LTM =====
STM_TOKEN_THRESHOLD = _env_int("STM_TOKEN_THRESHOLD", 48000, minimum=1)
STM_KEEP_RECENT = _env_int("STM_KEEP_RECENT", 8, minimum=0)
STM_POST_COMPRESSION_TARGET_TOKENS = _env_int("STM_POST_COMPRESSION_TARGET_TOKENS", 12000, minimum=64)
STM_SUMMARY_TARGET_TOKENS = _env_int("STM_SUMMARY_TARGET_TOKENS", 4000, minimum=64)
